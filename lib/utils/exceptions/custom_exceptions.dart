class EarthFirebaseAuthException implements Exception {
  final String code;
  EarthFirebaseAuthException(this.code);
...
class EarthFirebaseException implements Exception {
  final String code;
  EarthFirebaseException(this.code);
...
class EarthFormatException implements Exception {
  String? code;
  EarthFormatException({this.code});
...
class EarthPlatformException implements Exception {
  final String code;
  EarthPlatformException(this.code);
